  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        remember?localStorage.setItem('user',JSON.stringify({username,password})):localStorage.removeItem('username')
        this.login({username,password})
      }
    })
  }

  setFromData = username => {
    this.props.form.setFieldsValue({username,password:'admin'})
  }
